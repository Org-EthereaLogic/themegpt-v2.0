# Daily Metrics Report: 2026-03-02 (Afternoon)
...
|---------|----------|---------|-------------|-------------|
| Cross-network | 4 | 4 | 0.0% | 2.6s |
| Unassigned | 4 | 0 | 100.0% | 2.8s |
| Paid Search | 2 | 1 | 50.0% | 0.0s |
| Referral | 2 | 2 | 0.0% | 147.5s |

### Device Split

| Device | Sessions | Bounce Rate | Avg Duration |
|--------|----------|-------------|-------------|
| desktop | 8 | 12.5% | 39.6s |
