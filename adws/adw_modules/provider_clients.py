...
class ClaudeClient(ProviderClient):
    """
    Claude Opus 4.6 client (The Architect).

    Model: claude-opus-4-6-20260205 (configurable via env)
    """
    ...
    def __init__(self, api_key: str | None = None) -> None:
        ...
        self.model = os.getenv("TRINITY_ARCHITECT_MODEL", "claude-opus-4-6-20260205")
...
class GPTClient(ProviderClient):
    ...
    Primary: gpt-5.3-codex (configurable via env)
    Fallback chain: gpt-5.3 → gpt-5.2-codex → gpt-5.2
    """
    ...
    def __init__(self, api_key: str | None = None) -> None:
        ...
        env_model = os.getenv("TRINITY_CRITIC_MODEL", "gpt-5.3-codex")
