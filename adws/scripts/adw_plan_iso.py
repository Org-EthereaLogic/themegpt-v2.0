...
async def execute_planning(
    ...
    # 3. Initialize state (model names added after Trinity client init)
    ...
    # Now that clients are initialized, record model versions in state
    architect_model = trinity.clients["architect"].model
    critic_model = trinity.clients["critic"].model
    advocate_model = trinity.clients["advocate"].model
    ...
    state_manager.initialize(
        ...
        repo_url=repo_url,
        trinity_architect_model=architect_model,
        trinity_critic_model=critic_model,
        trinity_advocate_model=advocate_model,
    )
    console.print(f"  [green]State:[/] agents/{adw_id}/adw_state.json")
    console.print(f"  [green]Models:[/] {architect_model} / {critic_model} / {advocate_model}")
