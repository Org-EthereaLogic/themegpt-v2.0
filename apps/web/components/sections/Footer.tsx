...
const footerLinks = [
  ...
  { label: "Chrome Web Store", href: "https://chromewebstore.google.com/detail/dlphknialdlpmcgoknkcmapmclgckhba?utm_source=cws&utm_medium=share&utm_campaign=item-share", external: true },
];
